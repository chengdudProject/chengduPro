      ...
      <el-col :span="14" id="searchBox-content-left">
        <div class="grid-content">
          ...
          <div class="grid-content-detail" v-show="isCard">
            <count-item
              countTitle="智能计算"
              countTitleDes="仅显示该问题的智能计算的内容"
              countTitleColor="#4FADFF"
            >
              <div id="intelligent-computing">
                ...
                <div class="computing-content">
                  <p class="computing-content-title">
                    建行银行<span>信用卡</span>
                  </p>
                  <p class="computing-content-text">
                    建行信用卡是中国建设银行发行的信用卡。中国建设银行已经发行的信用卡都以“龙卡”冠名，种类有：龙卡名校卡，龙卡商务卡，龙卡汽车卡等。免年费政策：普卡金卡刷卡三次或18次免次年年费（不包括商务卡，汽车卡等特殊卡种）取现手续费：境内：交易金额5%o，最低2元，最高50元
                  </p>
                  <p class="computing-content-number">
                    建行发卡量：1.28亿张；累计客户：9460万户
                  </p>
                  <p class="computing-content-tip">
                    申请条件：1.申请人的年龄在18周岁以上，是具有民事行为能力的公民；2.有合法的职业和稳定的收入，是具有民事行为能力的公民；3.没有不良信用记录
                  </p>
                </div>
            ...
            <count-item
              countTitle="思维导图"
              countTitleDes="仅显示部分热门信息，更多请点击或直接搜索问题"
              countTitleColor="#FF9831"
              height="150"
            >
              <div id="mind-map">
                <ul>
                  <li>
                    <img
                      src="/static/img/searchBg.png"
                      @click="togo('mindMapping')"
                    />
                    <p>建行信用卡</p>
                  </li>
                  <li>
              ...
              <div id="relevant-tags">
                ...
                <div class="relevant-tags-content">
                  ...
                  <div class="tags-detail">
                    ...
                    <p class="tags-detail-text">
                      LINEFRIENDS粉丝信用卡是中国建设银行面向年轻爱玩的LINEFRIENDS粉丝客户推出的首张粉丝挚爱白金信用卡。产品采用萌宠形象，糖果配色，和卡号后置等功能
                    </p>
            ...
            <count-item
              countTitle="内容精选"
              countTitleDes="仅显示部分热门信息，更多请点击或直接搜索问题"
              countTitleColor="#2DF2FF"
            >
              <div id="content-select">
                <ul>
                  <li
                    v-for="(item, index) in contentSelectList"
                    :key="index"
              ...
              <li v-for="(item, linksIndex) in linkList" :key="linksIndex">
                ...
                <ul class="link-detail">
                  <li
                    ...
                    v-for="(temp, index) in item.detailList"
                    :key="index"
                  >
                    {{ temp }}
                  </li>
            ...
            >
              <div id="profile">
                ...
                <div class="profile-content">
                  ...
                  <p class="profile-content-des">
                    简介：LAMP兄弟连教学总监，毕业于首都经贸大学计算机系，拥有多年软件开发经验，曾先后人大连科特软件公司高级软件工程师，香港及时集团管理部总经理，北京校区副校长，东软长春办事处高级技术教师，具有扎实的技术工地和丰富的教学经验，精通各种操作系统，嵌入式开发、C、C++、J2EE、J2ME、J2SE、LAMP开发及Oracle数据库等技术；2004年开始从事IT技术培训，具有扎实的技术功底和丰富的教学经验，国内最高的PHP技术讲师之一，具有五年软件开发工作经验、四年IT教学经验
                  </p>
                </div>
              </div>
            </count-item>
        ...
        <div class="grid-content">
          ...
          <div id="business-style">
            <ul class="business-style-tab">
              <li
                :class="businessTabIndex == 0 ? 'active' : ''"
                @click="businessTabClick(0)"
              >
                热门项目
              </li>
              <li
                :class="businessTabIndex == 1 ? 'active' : ''"
                @click="businessTabClick(1)"
              >
                热搜人物
              </li>
              <li
                :class="businessTabIndex == 2 ? 'active' : ''"
                @click="businessTabClick(2)"
              >
                活跃小组
              </li>
              <li
                :class="businessTabIndex == 3 ? 'active' : ''"
                @click="businessTabClick(3)"
              >
                最近上线
              </li>
              <li
                :class="businessTabIndex == 4 ? 'active' : ''"
                @click="businessTabClick(4)"
              >
                重要通知
              </li>
            </ul>
            <div class="business-style-list">
              <ul>
                <li
                  v-for="(item, index) in businessStyleList"
                  :key="index"
                  :class="`background-${item.background}`"
                >
                  <div class="item-value">{{ item.value }}</div>
                  <div class="border-base1"></div>
                  <div class="border-base2"></div>
                </li>
              </ul>
            </div>
          ...
          <div id="relation-network" v-show="isPerson || isCard">
            ...
            <el-button
              type="primary"
              class="relation-network-btn"
              @click="makeComparison"
              >比一比</el-button
            >
          </div>
  ...
  data() {
    return {
      ...
      linkList: [
        {
          title:
            "<span style='color:#D43134'>信用卡</span>和理财服务，就在建行私人信贷平台",
          url: "https://www.rong360.com/",
          text:
            "建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品",
          detailList: [
            "住房贷款",
            "信贷经理",
            "登录信用卡",
      ...
      selectLinkList: [
        {
          title:
            "<span style='color:#D43134'>信用卡</span>的<span style='color:#D43134'>功能</span>是什么",
          url: "https://www.rong360.com/",
          text:
            "建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品",
          detailList: []
        ...
        {
          title:
            "<span style='color:#D43134'>信用卡</span>的量<span style='color:#D43134'>人均发卡量</span>是多少",
          url: "https://www.rong360.com/",
          text:
            "建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品",
          detailList: []
        ...
        {
          title:
            "<span style='color:#D43134'>信用卡</span>的<span style='color:#D43134'>发卡量</span>是多少",
          url: "https://www.rong360.com/",
          text:
            "建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品",
          detailList: []
        ...
        {
          title:
            "<span style='color:#D43134'>信用卡</span>的<span style='color:#D43134'>免息期</span>是多久",
          url: "https://www.rong360.com/",
          text:
            "建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品",
          detailList: []
        ...
        {
          title:
            "<span style='color:#D43134'>信用卡</span>的<span style='color:#D43134'>有效期</span>是多久",
          url: "https://www.rong360.com/",
          text:
            "建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品",
          detailList: []
        ...
        {
          title:
            "<span style='color:#D43134'>信用卡</span>的<span style='color:#D43134'>年利率</span>是多少",
          url: "https://www.rong360.com/",
          text:
            "建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品建行私人信贷平台是专注于金融领域的智能搜索平台，为企业和个人提供专业的贷款，信用卡及理财在线搜索和申请服务，目前已合作近10000家金融机构，涵盖30000款金融产品",
          detailList: []
  ...
  methods: {
    ...
    dragEnd: function(event, node) {
      ...
      if (node.id === this.initialData.id) {
        this.initialData.positionX =
          node.positionX + (nodeXY.x - me.startNode.positionX);
        this.initialData.positionY =
          node.positionY + (nodeXY.y - me.startNode.positionY);
      }
    },
    ...
    #searchBox-content-left {
      ...
      .grid-content-link {
        ...
        .showMore {
          ...
          color: #fff;
          cursor: pointer;
          background: url("/static/img/showMore.png") no-repeat 56% center
            #242a39;
        }
      }
    }
